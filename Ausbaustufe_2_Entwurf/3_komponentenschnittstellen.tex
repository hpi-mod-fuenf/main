...
\subsection{\textit{Interfaces}}
	...
	Erreicht die \texit{RobotUnit} eine ihr eine aus dem aktuellen \textit{Task} vorgegebene \textit{Destination}, informiert Sie mittels der Methode \texttt{informAboutArrival} aus dem Interface \texit{IArrivalNotification} den Server über seine Ankunft.
	\begin{figure}[H]
	\centering
