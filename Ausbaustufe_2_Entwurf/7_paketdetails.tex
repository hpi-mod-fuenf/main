...
\subsection{Paket \textit{RobotUnit}}
	Im Folgenden beschreiben wir die wichtigen Klassen des Pakets \textit{RobotUnit} 
...
%		\end{figure}
		...
		Die Klasse \textit{RobotController} ist die Hauptklasse der \textit{RobotUnit}, 
		da sie den aktuellen Zustand der \textit{RobotUnit} enthält.
