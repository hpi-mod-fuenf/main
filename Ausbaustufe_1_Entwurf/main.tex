...
\newpage
\input{1_abstrakte_architektur}
\newpage
\input{2_interaktion_der_komponenten}
\newpage
\input{3_komponentenschnittstellen}
\newpage
\input{4_konkrete_architektur}
\newpage
\input{5_komponenten}
\newpage
\input{6_paketstruktur}
\newpage
\input{7_paketdetails}
\newpage
\input{8_ablaeufe}
\newpage
\input{9_produkteinsatz}
