...
\end{figure}
In Abbildung \ref{KomponentenStruktur2} ist das Komponentendiagramm der Komponente \textit{RobotSoftware} dargestellt. Die Komponente enthält 3 Klassen: \textit{DrivingSystem}, \textit{RobotController} und \textit{Task}.
