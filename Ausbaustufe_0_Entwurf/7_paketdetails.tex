...
\begin{figure}[H]
	...
	\subsubsection{Beschreibung der Klasse \textit{TaskSystem}}
		%	-taskDistribution
			...
			\subsubsubsection{Beschreibung der Methode \textit{chooseRobot}}
			
	%7.2.2 RobotControlSystem
	\subsubsection{Beschreibung der Klasse \textit{RobotControlSystem}}
		
			%7.2.2.1	~assignTask(robot : Robot, destination : Destination): void
			\subsubsubsection{Beschreibung der Methode \textit{assignTask}}